...
class Bootstrap extends CApplicationComponent
{
	 ...
	 */
	public function registerAllJsPlugin()
	{
		...
		$cs->registerScriptFile($this->getAssetsUrl() . '/js/bootstrap-popover.js');
		$cs->registerScriptFile($this->getAssetsUrl() . '/js/bootstrap-button.js');
	...
	public function registerResponsiveCss()
	{
		...
		$cs->registerCssFile($this->getAssetsUrl() . '/css/bootstrap-responsive.rtl' . (!YII_DEBUG ? '.min' : '') . '.css');
	}
	...
	{
		$this->registerAssetCss('font-awesome.rtl' . (!YII_DEBUG ? '.min' : '') . '.css');
	}
